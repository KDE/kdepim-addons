    ...
    , mQuickTextConfigureWidget(new QuickTextConfigureWidget(this))
{
    ...
    auto exportButton = new QPushButton(i18nc("@action:button", "Export…"), this);
...
void QuickTextConfigureDialog::readConfig()
{
    ...
    TextAddonsWidgets::LoadDialogSizeUtils::loadDialogSizeScaled(this, QLatin1StringView(myConfigGroupName), 300, 350);
}
